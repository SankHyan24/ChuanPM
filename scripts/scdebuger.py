...
def render_graph_DefaultRenderGraph():
    ...
    g.create_pass('VBufferSC', 'VBufferSC', {'outputSize': 'Default', 'samplePattern': 'Center', 'sampleCount': 16, 'useAlphaTest': True, 'adjustShadingNormals': True, 'forceCullMode': False, 'cull': 'Back', 'useTraceRayInline': False, 'useDOF': True, 'specRoughCutoff': 0.10000000149011612, 'recursionDepth': 10})
